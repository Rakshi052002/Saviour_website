...
//updating the table
$result = mysqli_query($mysqli, "UPDATE `vaccupdate` SET Available='$Available' WHERE Center='$Center' and Vacctype='$Vacctype'");
header('Location:viewvacc.php');
}
?>
</body>
</html>
...
<body>  
    <form style="margin-left: 39%;" method="post" action="updatevacc.php" class="up">  
        <div class="container">
            <h1>UPDATE  AVAILABILITY </h1>
            <input type="text" placeholder="Enter Center" name="Center" class="user"required>  <br><br>
            <input type="text" placeholder="enter Vacctionation type" name="Vacctype" class="pass" required>  <br><br>
