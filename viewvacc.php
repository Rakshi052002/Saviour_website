...
$result=mysqli_query($mysqli, "SELECT * FROM userdetails");
?>
<html>
<head>
<style>
...
<h1 align="center"> Vaccination Bookings</h1>
<hr />
...
include_once("config.php");
//fetching data in descending order (lastest entry first)
$result=mysqli_query($mysqli, "SELECT * FROM vaccupdate");
?>
<BR><BR><BR>
<html>
<body>
<h1 align="center">Vaccination Availability</h1>
<hr />
<table width='100%' border=0>
<tr bgcolor='#CCCCCC'>
<td>Center</td>
