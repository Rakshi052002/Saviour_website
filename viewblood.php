...
$result=mysqli_query($mysqli, "SELECT * FROM blood");
?>
<html>
<head>
<style>
...
"></i></span>
        ...
        <br><br><br>
<h1 align="center"> Blood Donation Bookings</h1>
<hr />
...
include_once("config.php");
//fetching data in descending order (lastest entry first)
$result=mysqli_query($mysqli, "SELECT * FROM bloodupdate");
?>
<html>
<head>
</head>
<body>
<h1 align="center">Blood donation Availability</h1>
<hr />
<table width='100%' border=0>
<tr bgcolor='#CCCCCC'>
<td>Center</td>
<td>Time slot</td>
<td>slots Available in this type</td>
</tr>
<?php
while($res = mysqli_fetch_array($result)) {
echo "<tr>";
